 ...
 */
public class DeleteDirectoryCommand extends SafenetCommand<String> {
    ...
    public DeleteDirectoryCommand(WebTarget webTarget, Token token, String rootPath, String queryPath) {
        super(String.class);
